...
print (f"There are {total_number_of_loans} number of loans in the list.")
...
print (f"The sum of all the loans is {sum_of_loans}. ")
...
print (f"The average loan ammount is: {average_loan_price}.")
...
if fair_value >= average_loan_price:
...
def present_value (future_value, remaining_months, annual_discount_rate):
    current_present_value = future_value / (1 + annual_discount_rate / 12) ** remaining_months
...
with open (output_path, 'w', newline = "") as csvfile:
    ...
    for loanvalues in inexpensive_loans:
